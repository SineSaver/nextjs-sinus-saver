...
export default function AdminLayout({children, devices}: AdminLayoutProps) {
    ...
    return (
        <>
            <Head>
                <title>Sinus Saver</title>
                <meta name="description" content="sinus saver app"/>
                <link rel="icon" href="/favicon.ico"/>
            </Head>

            <div ref={ref} className="position-absolute w-100"/>

            <Sidebar isShow={isShowSidebar} isShowMd={isShowSidebarMd} devices={devices}/>
